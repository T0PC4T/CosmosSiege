...
# MENU TITLE
TITLE_STRIP_HEIGHT = TILE_SIZE
TITLE_STRIP_WIDTH = MENU_WIDTH
TITLE_STRIP_X = MENU_X
TITLE_STRIP_Y = TEXT_PADDING
...
# UNIT INFO
UNIT_INFO_HEIGHT = TILE_SIZE * 4
UNIT_INFO_WIDTH = MENU_WIDTH
UNIT_INFO_Y = UNIT_IMG_Y + UNIT_IMG_HEIGHT
UNIT_INFO_X = MENU_X
UNIT_INFO_TITLE = 26
UNIT_INFO_TEXT_SIZE = 20
UNIT_BTNS_TEXT_SIZE = 15

# MENU DATA RECORDS
UNIT_BTN_NUM = 4
UNIT_BTN_WIDTH = MENU_WIDTH
UNIT_BTN_HEIGHT = TILE_SIZE * 2

UNIT_BTN_LIST_WIDTH = MENU_WIDTH
UNIT_BTN_LIST_HEIGHT = UNIT_BTN_HEIGHT * UNIT_BTN_NUM
UNIT_BTN_LIST_X = MENU_X
UNIT_BTN_LIST_Y = UNIT_INFO_Y + UNIT_INFO_HEIGHT

PAGE_BTN_WIDTH = TILE_SIZE
PAGE_BTN_HEIGHT = TILE_SIZE
PAGE_PREV_X = MENU_X
PAGE_NEXT_X = WIDTH - PAGE_BTN_WIDTH
PAGE_Y = UNIT_BTN_LIST_Y + UNIT_BTN_LIST_HEIGHT

# GLOBAL INFO
GLOBAL_INFO_HEIGHT = TILE_SIZE * 4
GLOBAL_INFO_WIDTH = MENU_WIDTH
GLOBAL_INFO_Y = PAGE_Y + PAGE_BTN_HEIGHT
GLOBAL_INFO_X = MENU_X
GLOBAL_INFO_TEXT_SIZE = 22

# MENU READY BTN
MENU_READY_COLOUR = (51, 255, 0)
MENU_READY_HEIGHT = TILE_SIZE * 2
MENU_READY_WIDTH = UNIT_BTN_LIST_WIDTH
MENU_READY_X = MENU_X
